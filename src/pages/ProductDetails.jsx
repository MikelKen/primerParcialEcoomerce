      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        {/**product details */}
        {
          loading ? (
            ...
            <div className='text-blue-700 bg-slate-200 h-6 lg:h-8  animate-pulse flex items-center gap-1 w-full'>
            ...
            <p className='bg-blue-200 text-blue-700 px-2 rounded-full imline-block w-fit'>{data?.brandName}</p>
            ...
            <div className='flex items-center gap-2 text-2x1 lg:text-3xl font-medium my-1'>
              <p className='text-blue-700'>{displayINRCurrency(data.sellingPrice)}</p>
              <p className='text-slate-400 line-through'>{displayINRCurrency(data.price)}</p>
            </div>

            <div className='flex items-center gap-3 my-2'>
              <button className='border-2 border-blue-600 rounded px-3 py-1 min-w-[120px] text-blue-600 font-medium hover:bg-blue-600 hover:text-white' onClick={(e)=>handleByProduct(e,data?._id)}>Buy</button>
